distributions <- list(
  small = function() {
    data.frame(
      ...
      chi_sq = rchisq(n = 100, df = 10),
      t_dist = rt(n = 100, df = 30),
  ...
  medium = function() {
    data.frame(
      ...
      bern = rbinom(n = 1000, size = 1, prob = 0.50),
      ...
      chi_sq = rchisq(n = 1000, df = 10),
      t_dist = rt(n = 1000, df = 30),
  ...
  large = function() {
    data.frame(
      ...
      bern = rbinom(n = 10000, size = 1, prob = 0.50),
